import { appendHeader, defineEventHandler, EventHandler, EventHandlerRequest, getCookie, setResponseStatus } from "h3";
import { defineAuthenticatedEventPostHandlers } from "./authenticatedPostHandler.js";
import { Cookies, CreationSuccess, getLogger, newApiTokenSchema, parseResponseContentType, privilegeQ, reqParams, Results, safeAction, validateZodSchema, ipRestrictionUpdate, AllValidTokensList, ActionManagerResult, tokenId, InternalUnion, SingleTokenMeta, ApiTokenRotationSuccess } from "@internal/shared";
import z from "zod";
