export const serverImports = [
  ...
  { name: 'verifyTempPasswordLink', from: 'auth-h3client/v1' },
  { name: 'verifyTempMfaLink', from: 'auth-h3client/v1' },
  ...
  { name: 'getSafeUrl', from: 'auth-h3client/v1' },
  { name: 'configuration', from: 'auth-h3client/v1' },
